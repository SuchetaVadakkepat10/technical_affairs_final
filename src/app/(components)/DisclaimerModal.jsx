      ...
      <div className="inline-block align-bottom border border-solid border-black bg-gradient-to-r from-[#ACDDF9] to-[#879CFD] rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        ...
        <div className="p-6">
          ...
          <p>
            ...
            legal contract between Tech Affairs and any person or entity unless
            otherwise specified. Information on official Tech Affairs websites
            is subject to change without prior notice. Although every reasonable
            effort is made to present current and accurate information, Tech
            Affairs makes no guarantees of any kind. The Tech Affairs website
            may contain information that is created and maintained by a variety
            of sources both internal and external to the Institute. These sites
            are unmoderated forums containing the personal opinions and other
            expressions of the persons who post the entries. Tech Affairs does
            not control, monitor, or guarantee the information contained in
            these sites or information contained in links to other external
            websites, and does not endorse any views expressed or products or
            services offered therein. In no event shall tech Affairs be
