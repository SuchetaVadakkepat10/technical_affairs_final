...
const Card = ({ title, logo, links }) => {
  return (
    <div className="border border-solid border-black bg-gradient-to-r from-[#ACDDF9] to-[#879CFD] p-2 m-4 shadow-md flex flex-col items-center justify-center text-center hover:scale-105 hover:cursor-pointer  w-[250px] h-[229 px]">
      <div>
        {/* ClubLogo */}
        <div className="my-2 shadow-sm transition-transform transform hover:scale-105">
